            ...
            <div class="card-wrapper">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">Lihat Data Jadwal</h3>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                    <form class="needs-validation">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $jadwal->tanggal }}" id="validationCustom01" placeholder="Tanggal" disabled>
                            </div>
                            <div class="col-md-6 mb-3">
                              <label class="form-control-label" for="validationCustom01">Waktu</label>
                              <input type="text" class="form-control" value="{{ $jadwal->waktu }}" id="validationCustom01" placeholder="Tanggal" disabled>
                          </div>
                        </div>
                        <a href="{{ URL::to('/admin/jadwal') }}" class="btn btn-primary">Kembali</a>
                    </form>
                    </div>
                </div>
            </div>
