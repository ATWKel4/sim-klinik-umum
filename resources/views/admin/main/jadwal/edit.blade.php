        ...
        <div class="col">
            <div class="card-wrapper">
                <div class="card">
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                    <form class="needs-validation" novalidate="false" method="PUT" action="{{ URL::to('/admin/jadwal') }}">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-8 mb-3">
                                <label class="form-control-label" for="validationCustom01">Tanggal</label>
                                <input type="text" class="form-control" name="nama" value="{{ $jadwal->tanggal }}" id="validationCustom01" placeholder="Nama Penyakit">
                            ...
                            <div class="col-md-4 mb-3">
                              ...
                              <input type="text" class="form-control" name="nama" value="{{ $jadwal->waktu }}" id="validationCustom01" placeholder="Nama Penyakit">
                              <div class="valid-feedback">
                                  Waktu Sudah Valid
                              </div>
                              <div class="invalid-feedback">
