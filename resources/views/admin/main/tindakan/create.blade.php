            ...
            <div class="card-wrapper">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">Tambah Data Tindakan</h3>
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                    <form class="needs-validation" novalidate="false" method="POST" action="{{ URL::to('/admin/tindakan') }}">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label class="form-control-label" for="validationCustom01">Diagnosis</label>
                                <input type="text" class="form-control" name="diagnosis" id="validationCustom01" placeholder="Tuliskan diagnosis">
                                <div class="valid-feedback">
                                    Keterangan diagnosis sudah valid
                                </div>
                                <div class="invalid-feedback">
                                    Tolong masukkan format diagnosis yang valid
                                </div>
                            </div>
                            <div class="col-md-12 mb-3">
                              <label class="form-control-label" for="validationCustom01">Deskripsi</label>
                              <input type="text" class="form-control" name="deskripsi" id="validationCustom01" placeholder="Tuliskan deskripsinya">
                              <div class="valid-feedback">
                                  Deskripsi tindakan Sudah Valid
                              </div>
                              <div class="invalid-feedback">
                                  Tolong masukkan format deskripsi yang valid
                              </div>
                          </div>
                        </div>
