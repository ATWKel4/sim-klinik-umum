    ...
    <div class="header bg-primary pb-6">
        <div class="container-fluid">
            ...
            <div class="row align-items-center py-4">
                ...
                <a href="{{ URL::to('/admin/penyakit/create') }}" class="btn btn-sm btn-neutral">New</a>
            ...
            <div class="card-wrapper">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">Ubah Data Tindakan</h3>
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                    <form class="needs-validation" novalidate="false" method="PUT" action="{{ URL::to('/admin/tindakan') }}">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                <label class="form-control-label" for="validationCustom01">Diagnosis</label>
                                <input type="text" class="form-control" name="diagnosis" value="{{ $tindakan->diagnosis }}" id="validationCustom01" placeholder="Nama Penyakit">
                                <div class="valid-feedback">
                                    Keterangan tindakan sudah valid
                                </div>
                                <div class="invalid-feedback">
                                    Tolong masukkan tindakan yang valid
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                              <label class="form-control-label" for="validationCustom01">Deskripsi</label>
                              <input type="text" class="form-control" name="deskripsi" value="{{ $tindakan->deskripsi }}" id="validationCustom01" placeholder="Nama Penyakit">
                              <div class="valid-feedback">
                                  Keterangan deskripsi sudah valid
                              </div>
                              <div class="invalid-feedback">
                                  Tolong masukkan deskripsi yang valid
                              </div>
                          </div>
                        </div>
