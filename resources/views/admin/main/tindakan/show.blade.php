            ...
            <div class="card-wrapper">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">Lihat Data Tindakan</h3>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                      <form class="needs-validation">
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $tindakan->diagnosis }}" id="validationCustom01" placeholder="Tuliskan diagnosis" disabled>
                            </div>
                            <div class="col-md-12 mb-3">
                              <label class="form-control-label" for="validationCustom01">Deskripsi</label>
                              <input type="text" class="form-control" value="{{ $tindakan->deskripsi }}" id="validationCustom01" placeholder="Tuliskan deskripsinya" disabled>
                          </div>
                        </div>
                        <a class="btn btn-primary" href="{{ URL::to('/admin/tindakan') }}">Kembali</a>
                    </form>
                    </div>
                </div>
            </div>
