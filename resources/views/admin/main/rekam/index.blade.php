            ...
            <div class="table-responsive py-1">
              <table class="table table-flush" id="datatable-basic">
                ...
                @foreach ($rekam as $r)
                  <tr>
                    <td>{{ $r->users_nama }}</td>
                    <td>{{ $r->penyakit_nama }}</td>
                    <td>{{ $r->deskripsi }}</td>
                    <td>{{ $r->catatan }}</td>
                    <td>{{ $r->tanggal }}</td>
                    <td>
                      <a href="{{ URL::to('/admin/rekam/'.$r->id) }}" class="btn btn-vimeo btn-icon-only">
                        <span class="btn-inner--icon"><i class="fa fa-eye"></i></span>
                      </a>
                      <a href="{{ URL::to('/admin/rekam/'.$r->id.'/edit') }}" class="btn btn-slack btn-icon-only">
                      ...
                      <form id="delete" style="display: none" method="POST" action="{{ URL::to('/admin/rekam/'.$r->id) }}">
                        @csrf
