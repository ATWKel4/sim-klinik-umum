...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="card card-stats">
            ...
            <div class="row">
                <div class="col">
                <h5 class="card-title text-uppercase text-muted mb-0">Antrian</h5>
                <span class="h2 font-weight-bold mb-0">{{ $antrian }}</span>
                </div>
                <div class="col-auto">
        ...
        <div class="card card-stats">
            ...
            <p class="mt-3 mb-0 text-sm">
                <span class="text-nowrap">Dalam 1 minggu terakhir</span>
            </p>
            </div>
        </div>
        </div>
        ...
        <div class="card card-stats">
            ...
            <div class="row">
                ...
                <span class="h2 font-weight-bold mb-0">{{ $total_pendapatan }}</span>
                </div>
                <div class="col-auto">
        ...
        <div class="card card-stats">
            ...
            <div class="row">
                <div class="col">
                <h5 class="card-title text-uppercase text-muted mb-0">Jenis Obat</h5>
                <span class="h2 font-weight-bold mb-0">{{ $total_jenis_obat }}</span>
                </div>
                <div class="col-auto">
            ...
            <p class="mt-3 mb-0 text-sm">
                <span class="text-nowrap">Saat ini</span>
            </p>
            </div>
        </div>
        </div>
