        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0">Resep</h3>
              <p class="text-sm mb-0">
                Berisi Daftar aturan konsumsi obat pasien
              </p>
              ...
              <table class="table table-flush" id="datatable-basic">
                ...
                @foreach ($resep as $r)
                  <tr>
                    ...
                    <td>{{ $r->catatan }}</td>
                    <td>
                      <a href="{{ URL::to('/admin/resep/'.$r->id) }}" class="btn btn-vimeo btn-icon-only">
                        <span class="btn-inner--icon"><i class="fa fa-eye"></i></span>
                      </a>
                      <a href="{{ URL::to('/admin/resep/'.$r->id.'/edit') }}" class="btn btn-slack btn-icon-only">
                      ...
                      <form id="delete" style="display: none" method="POST" action="{{ URL::to('/admin/resep/'.$r->id) }}">
                        @csrf
