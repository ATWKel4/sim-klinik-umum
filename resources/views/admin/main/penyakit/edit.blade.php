            ...
            <div class="card-wrapper">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">Ubah Data Penyakit</h3>
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                    <form class="needs-validation" novalidate="false" method="PUT" action="{{ URL::to('/admin/penyakit') }}">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label class="form-control-label" for="validationCustom01">Nama Penyakit</label>
                                <input type="text" class="form-control" name="nama" value="{{ $penyakit->nama }}" id="validationCustom01" placeholder="Nama Penyakit">
                                <div class="valid-feedback">
                                    Nama penyakit Sudah Valid
                                </div>
                                <div class="invalid-feedback">
                                    Tolong masukkan nama penyakit yang valid
                                </div>
                            </div>
                        </div>
