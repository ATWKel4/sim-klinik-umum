            ...
            <div class="card-wrapper">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">Lihat Data Penyakit</h3>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                    <form class="needs-validation" novalidate="false" method="POST" action="{{ URL::to('/admin/penyakit') }}">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label class="form-control-label" for="validationCustom01">Nama Penyakit</label>
                                <input type="text" class="form-control" value="{{ $penyakit->nama }}" id="validationCustom01" placeholder="Nama Penyakit" disabled>
                            </div>
                        </div>
                        <a href="{{ URL::to('/admin/penyakit') }}" class="btn btn-primary">Kembali</a>
                    </form>
                    </div>
                </div>
            </div>
